...
public class Deleteuser {
    ...
    ResultSet rs ;
    public Deleteuser(){
            JFrame f = new JFrame("Delete User Page");
      JButton b = new JButton("Delete");
      JButton b1 = new JButton("Back");
      JLabel l1 = new JLabel("Seatno");//for id
         ...
         b.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e){
                try {
                    ...
                    String s = "delete from book where Seatno = '"+ t.getText() +"' ";
                    ...
                    if(st.executeUpdate(s) == 1){
                        ...
                        JOptionPane.showMessageDialog(null, "No such Seat is found");
                    }
